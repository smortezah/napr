...
def data():
    ...
    def _rand_textTaxa():
        ...
        return random.choices(population=["plants", "marine", "bacteria", "fungi"], k=size)
    ...
    data["directParentClassification"] = rand_list_string(str_len=5, list_size=size)  # type: ignore
