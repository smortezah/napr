...
from napr.coconut.plotting._base import set_plt_style
from napr.coconut.terpene import explore
from napr.coconut.terpene.preprocessing import DimReduce, Preprocess
from napr.decorators import info
...
class Terpene:
    ...
    def preprocess(self, **kwargs) -> None:
        ...
        Args:
            **kwargs:
                random_state: The random state for train_test_split. Defaults to 777.
    ...
    def dim_reduce(self, inplace: bool = True, **kwargs) -> pd.DataFrame | None:
        ...
        Args:
            ...
            **kwargs:
                model: The model to use for dimension reduction. Defaults to PCA keeping 95% of
                    the variance.
